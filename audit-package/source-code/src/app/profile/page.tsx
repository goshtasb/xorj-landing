...
export default function ProfilePage() {
  ...
  // Always enable development mode when NODE_ENV is development
  const isDevelopmentMode = process.env.NODE_ENV === 'development' || 
    (mounted && typeof window !== 'undefined' && window.location.search.includes('demo=true'));
  
  console.log('🔧 isDevelopmentMode debug:', { 
    isDevelopmentMode, 
    mounted, 
    hasWindow: typeof window !== 'undefined',
    hasDemo: typeof window !== 'undefined' ? window.location.search.includes('demo=true') : false,
