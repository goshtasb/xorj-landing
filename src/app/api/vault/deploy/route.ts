...
export async function POST(request: NextRequest) {
  try {
    const { network = 'devnet' } = await request.json();
    ...
    try {
      ...
      console.error('Error checking program deployment:');
    ...
    console.error('Smart contract deployment error:');
    return NextResponse.json(
      { 
        success: false,
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Smart contract status check error:');
    return NextResponse.json(
